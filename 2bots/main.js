...
tickfunction=()=>{
    ...
    if(ticks>=targetTicks){
        ...
        if(c[0]>c[1]){
            document.getElementById("score").style.backgroundColor="rgb(230,131,28)"
            document.getElementById("score").innerHTML=`${boardgame.bots[0].name} (Orange) won!<br>${b1}<br>${b0}<br>Days:${ticks}`
        }else if(c[0]<c[1]){
            document.getElementById("score").style.backgroundColor="rgb(117,212,135)"
            document.getElementById("score").innerHTML=`${boardgame.bots[1].name} (Green) won!<br>${b1}<br>${b0}<br>Days:${ticks}`
        }else{
            document.getElementById("score").style.backgroundColor="wheat"
            document.getElementById("score").innerHTML=`Tie!<br>${b1}<br>${b0}<br>Days:${ticks}`
        }
    }
